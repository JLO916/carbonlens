  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      <h1 className="text-3xl font-bold text-gray-900 mb-6">
        {t('關於 Carbon Lens 碳排鏡菱', 'About Carbon Lens')}
      </h1>

      <Card>
        <CardContent className="p-8 space-y-5 text-gray-600 leading-relaxed">
          <p>
            {t('Carbon Lens 碳排鏡菱 是一個免費的亞太碳成本分析工具，由', 'Carbon Lens is a free carbon cost analysis tool for Asia-Pacific, independently built and maintained by')}{' '}
          ...
          <p>
            {t(
              'Carbon Lens 碳排鏡菱 的目標是讓碳成本的估算變得透明、直覺、所有人都能使用。工具目前涵蓋六國國內碳定價機制和歐盟碳關稅（CBAM），未來將視法規變化和使用者回饋持續更新。',
              'Carbon Lens aims to make carbon cost estimation transparent, intuitive, and accessible to everyone. The tool currently covers six countries\' domestic carbon pricing mechanisms plus the EU carbon border tax (CBAM), and will be updated as regulations evolve and users provide feedback.'
            )}
          </p>
