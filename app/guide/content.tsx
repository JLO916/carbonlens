  ...
  return (
    <div className="mx-auto max-w-3xl space-y-10 px-4 py-10">
      ...
      <section id="how" className="scroll-mt-20 space-y-4">
        ...
        <Feature id="f-profile" shot={{ src: '/guide/g-profile.jpg', alt: t('① 公司基本:產業、年度、基準年與目標欄位', '① Company basics: industry, year, base year and target fields') }} icon="📝" title={t('填側寫(①–④)', 'Fill the profile (①–④)')} lead={t('工作台最上面是公司側寫。填一次,下面所有計算都用它。', 'The top of the workbench is your company profile. Fill it once; everything below uses it.')}>
