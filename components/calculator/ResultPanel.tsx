...
const STEP_LABELS: Record<string, { zhTW: string; en: string }> = {
  ...
  th_step_emissions: { zhTW: '課稅排放量（油品燃燒）', en: 'Taxable emissions (oil combustion)' },
  th_step_electricity_excluded: { zhTW: '電力排放（不在油品稅基，未課稅）', en: 'Electricity emissions (outside the oil-excise tax base, untaxed)' },
